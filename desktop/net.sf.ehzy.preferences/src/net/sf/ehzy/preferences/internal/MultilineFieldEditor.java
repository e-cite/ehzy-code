...
/**
 * A field editor for a multi-lined string type preference. This is essentially a 
 * copy of {@link StringFieldEditor} with the main difference that the editor is 
 * initialized with SWT.MULTI instead of SWT.SINGLE. 
 * Search for // >>> to find the changes in this file.
 * @author vwegert
 *
 */
public class MultilineFieldEditor extends FieldEditor {
    ...
    protected void doFillIntoGrid(Composite parent, int numColumns) {
        ...
        GridDataFactory.defaultsFor(label).align(SWT.BEGINNING, SWT.BEGINNING).applyTo(label);
        // >>> END OF CHANGE <<<
