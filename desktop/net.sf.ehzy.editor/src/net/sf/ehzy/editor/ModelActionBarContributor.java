...
public class ModelActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	...
	protected IAction showPropertiesViewAction =
		new Action(Messages.ModelActionBarContributor_ShowPropertiesViewActionLabel) {
			/* (non-Javadoc)
	...
	protected IAction refreshViewerAction =
		new Action(Messages.ModelActionBarContributor_RefreshActionLabel) {
			/* (non-Javadoc)
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(Messages.ModelActionBarContributor_MenuContributionLabel, "net.sf.ehzy.modelMenuID"); //$NON-NLS-2$
		...
		//
		createChildMenuManager = new MenuManager(Messages.ModelActionBarContributor_NewChildLabel);
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(Messages.ModelActionBarContributor_NewSiblingLabel);
	...
	public void selectionChanged(SelectionChangedEvent event) {
		...
		if (selection instanceof IStructuredSelection && ((IStructuredSelection)selection).size() == 1) {
			...
			Command command = commandService.getCommand(SendMessageHandler.COMMAND_ID);
			command.setEnabled((object instanceof Recipient));
		}
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(Messages.ModelActionBarContributor_NewChildLabel);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager); //$NON-NLS-1$

		submenuManager = new MenuManager(Messages.ModelActionBarContributor_NewSiblingLabel);
		populateManager(submenuManager, createSiblingActions, null);
		menuManager.insertBefore("edit", submenuManager); //$NON-NLS-1$
		
		menuManager.insertBefore("edit", new Separator("ehzy-actions")); //$NON-NLS-1$ //$NON-NLS-2$
	}
	 ...
	 * @see org.eclipse.emf.edit.ui.action.EditingDomainActionBarContributor#removeAllReferencesOnDelete()
	 */
	@Override
